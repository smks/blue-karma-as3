package interactive.compound.props
{
    ...
    public class Sofa extends Prop
    {
         ...
         */
        public function Sofa(id:String, examinable:Boolean = false)
        {
            super(id, examinable);
            setExaminable(true);
            setTouchable(true);
        ...
        {
            image = new Image(CompoundAssets.getAtlas().getTexture(CompoundAssets.SOFA));
            image.x = 0;
            image.y = 0;
            image.pivotX = 0;
            image.pivotY = 0;
