package interactive.compound.props
{
    ...
    public class Mirror extends Prop
    {
         ...
         */
        public function Mirror(id:String, examinable:Boolean = false)
        {
            super(id, examinable);
            setExaminable(true);
            setTouchable(true);
        ...
        {
            image = new Image(CompoundAssets.getAtlas().getTexture(CompoundAssets.MIRROR));
            image.x = 0;
            image.y = 0;
            image.pivotX = 0;
            image.pivotY = 0;
