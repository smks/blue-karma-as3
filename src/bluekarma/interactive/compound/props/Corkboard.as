package interactive.compound.props
{
    ...
    public class Corkboard extends Prop
    {
         ...
         */
        public function Corkboard(id:String, examinable:Boolean = false)
        {
            super(id, examinable);
            setExaminable(true);
            setTouchable(true);
        ...
        {
            image = new Image(CompoundAssets.getAtlas().getTexture(CompoundAssets.CORKBOARD));
            image.x = 0;
            image.y = 0;
            image.pivotX = 0;
            image.pivotY = 0;
