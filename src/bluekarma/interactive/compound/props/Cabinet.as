package interactive.compound.props
{
    ...
    public class Cabinet extends Prop
    {
         ...
         */
        public function Cabinet(id:String, examinable:Boolean = false)
        {
            super(id, examinable);
            setExaminable(true);
            setTouchable(true);
        ...
        {
            image = new Image(CompoundAssets.getAtlas().getTexture(CompoundAssets.CABINET));
            image.x = 0;
            image.y = 0;
            image.pivotX = 0;
            image.pivotY = 0;
