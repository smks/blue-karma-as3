package interactive.compound.props
{
    ...
    /**
     * Interactive Prop: IncognitiveMask
     * @author Shaun Stone (SMKS)
     * @website http://www.smks.co.uk
     * Created at: 08-01-2015 20:04:39
     */
    public class IncognitiveMask extends Prop
    {
        /**
         ...
         */
        public function IncognitiveMask(id:String, examinable:Boolean = false)
        {
            super(id, examinable);
            setExaminable(true);
            setTouchable(true);
        ...
        {
            image = new Image(CompoundAssets.getAtlas().getTexture(CompoundAssets.INCOGNITIVEMASK));
            image.x = 0;
            image.y = 0;
            image.pivotX = 0;
            image.pivotY = 0;
