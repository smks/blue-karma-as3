package bluekarma.interactive.compound.repos
{
     ...
     * @author Shaun Stone
     */
    public class CompoundInteractionRepo extends InteractionRepo
    {
        public function CompoundInteractionRepo()
        {
            fetchData();
        }
        ...
        protected function getXMLData():XML
        {
            ...
            return Level1DialogueAssets.getXMLData(Level1DialogueAssets.COMPOUND);
        }
    }
}