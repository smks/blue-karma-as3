package interactive.slumsalley.items
{
    ...
    /**
     * Interactive Item: Rock
     * @author Shaun Stone
     * Created at: 25-10-2014 11:37:20
     */
    public class Rock extends Item
    {
         ...
         */
        public function Rock(id:String, pickable:Boolean = false)
        {
            super(id, pickable);
            setExaminable(true);
        ...
        {
            image = new Image(ItemAssets.getAtlas().getTexture(ItemAssets.ROCK));
            image.width = 100;
            image.height = 100;
            image.scaleX = 1;
            image.scaleY = 1;
