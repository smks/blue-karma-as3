package bluekarma.interactive.backalley.repos
{
     ...
     * @author Shaun Stone
     */
    public class BackAlleyInteractionRepo extends InteractionRepo
    {
        public function BackAlleyInteractionRepo()
        {
            fetchData();
        }
        ...
        protected function getXMLData():XML
        {
            ...
            return Level1DialogueAssets.getXMLData(Level1DialogueAssets.BACK_ALLEY);
        }
    }
}